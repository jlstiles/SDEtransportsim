...
save(res100_YSmis1, func_list, covariates, file = "results3/res100_YSmis2.RData")
...
save(res500_YSmis1, func_list, covariates, file = "results3/res500_YSmis2.RData")
...
save(res5000_YSmis1, func_list, covariates, file = "results3/res5000_YSmis2.RData")
...
save(res5000_YSmis1, func_list, covariates, file = "results3/res5000_YSmis2_1.RData")