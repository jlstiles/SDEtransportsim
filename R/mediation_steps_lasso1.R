...
mediation.step1_lasso1 = function(initdata, Y_preds, data, gstarM_astar, a, transport) {
...
mediation.step2_lasso1 = function(data, Qstar_M, Qstar_Mg, Hm, A_ps, a, tmle = TRUE,
