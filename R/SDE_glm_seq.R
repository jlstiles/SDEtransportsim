...
SDE_glm_seq = function(data, forms, RCT = 0.5, transport, pooled, gstar_S = 0, truth, B = 500) 
{
  ...
  init_info = get.mediation.initdata_glm_seqT(data = data, forms = forms, RCT = RCT, pooled, transport)
...
#' @export
get_gstarM_glm_seqT  = function(data, truth, forms, transport, pooled, gstar_S) 
{
...
#' @export
get.mediation.initdata_glm_seqT = function(data, forms, RCT = 0.5, pooled, transport) {
