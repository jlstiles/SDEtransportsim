...
save(res100_Ymis, func_list, covariates, file = "test/res100_Ymis.RData")
...
save(res500_Ymis, func_list, covariates, file = "test/res500_Ymis.RData")
...
save(res5000_Ymis, func_list, covariates, file = "test/res5000_Ymis.RData")
