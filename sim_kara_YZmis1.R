...
save(res100_YZmis1, func_list, covariates, file = "results3/res100_YZmis2.RData")
...
save(res500_YZmis1, func_list, covariates, file = "results3/res500_YZmis2.RData")
...
save(res5000_YZmis1, func_list, covariates, file = "results3/res5000_YZmis2.RData")
...
save(res5000_YZmis1, func_list, covariates, file = "results3/res5000_YZmis2_1.RData")