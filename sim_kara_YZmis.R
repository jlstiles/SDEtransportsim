...
save(res100_YZmis, func_list, covariates, file = "results4/res100_YZmis.RData")
...
save(res500_YZmis, func_list, covariates, file = "results4/res500_YZmis.RData")
...
save(res5000_YZmis, func_list, covariates, file = "results4/res5000_YZmis.RData")
