...
forms = list(Sform = "S~W2", Aform = NULL, Zstarform = "Z ~ A:S", Mstarform = "M ~ Z+W2", 
...
save(res100_YZmis, func_list, forms, file = "results8/res100_YZmis.RData")
...
save(res500_YZmis, func_list, forms, file = "results8/res500_YZmis.RData")
...
save(res5000_YZmis, func_list, forms, file = "results8/res5000_YZmis.RData")
