...
save(res100_YZmis, func_list, forms, file = "results5/res100_YZmis.RData")
...
save(res500_YZmis, func_list, forms, file = "results5/res500_YZmis.RData")
...
save(res5000_YZmis, func_list, forms, file = "results5/res5000_YZmis.RData")
