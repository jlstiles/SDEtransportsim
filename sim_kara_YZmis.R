...
forms = list(Sform = "S~W1", Aform = NULL, Zstarform = "Z ~ A", Mstarform = "M ~ Z+W2", 
...
save(res100_YZmis, func_list, covariates, file = "results5/res100_YZmis.RData")
...
save(res500_YZmis, func_list, covariates, file = "results5/res500_YZmis.RData")
...
save(res5000_YZmis, func_list, covariates, file = "results5/res5000_YZmis.RData")
