...
res100_YMmis1 = mclapply(1:B, FUN = function(x) sim_kara(n, covariates, func_list), 
                       mc.cores = getOption("mc.cores", 20L))

save(res100_YMmis1, func_list, covariates, file = "results3/res100_YMmis2.RData")
...
save(res500_YMmis1, func_list, covariates, file = "results3/res500_YMmis2.RData")

B = 500
n=5000

res5000_YMmis1 = mclapply(1:B, FUN = function(x) sim_kara(n, covariates, func_list), 
                        mc.cores = getOption("mc.cores", 20L))

save(res5000_YMmis1, func_list, covariates, file = "results3/res5000_YMmis2.RData")
...
save(res5000_YMmis1, func_list, covariates, file = "results3/res5000_YMmis2_1.RData")