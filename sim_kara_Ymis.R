...
res100_Ymis = mclapply(1:B, FUN = function(x) sim_kara(n, covariates, func_list, B=NULL), 
                       mc.cores = getOption("mc.cores", 20L))

save(res100_Ymis, func_list, covariates, file = "results4/res100_Ymis.RData")

B = 1000
n=500

res500_Ymis = mclapply(1:B, FUN = function(x) sim_kara(n, covariates, func_list, B=NULL), 
                       mc.cores = getOption("mc.cores", 20L))

save(res500_Ymis, func_list, covariates, file = "results4/res500_Ymis.RData")

B = 1000
n=5000

res5000_Ymis = mclapply(1:B, FUN = function(x) sim_kara(n, covariates, func_list, B=NULL), 
                        mc.cores = getOption("mc.cores", 20L))

save(res5000_Ymis, func_list, covariates, file = "results4/res5000_Ymis.RData")
