...
forms = list(Sform = "S~W2", Aform = NULL, Zstarform = "Z ~ A + A:W2 + W2 + S", Mstarform = "M ~ Z+W2", 
...
save(res100_Ymis, func_list, forms, file = "results8/res100_Ymis.RData")
...
save(res500_Ymis, func_list, forms, file = "results8/res500_Ymis.RData")
...
save(res5000_Ymis, func_list, forms, file = "results8/res5000_Ymis.RData")
