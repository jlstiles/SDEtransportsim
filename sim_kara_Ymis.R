...
save(res100_Ymis, func_list, forms, file = "results9/res100_Ymis.RData")
...
save(res500_Ymis, func_list, forms, file = "results9/res500_Ymis.RData")
...
save(res5000_Ymis, func_list, forms, file = "results9/res5000_Ymis.RData")
