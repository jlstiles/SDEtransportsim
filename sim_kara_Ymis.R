...
save(res100_Ymis, func_list, covariates, file = "results5/res100_Ymis.RData")
...
save(res500_Ymis, func_list, covariates, file = "results5/res500_Ymis.RData")
...
save(res5000_Ymis, func_list, covariates, file = "results5/res5000_Ymis.RData")
