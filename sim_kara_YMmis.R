...
save(res100_YMmis, func_list, forms, file = "results5/res100_YMmis.RData")
...
save(res500_YMmis, func_list, forms, file = "results5/res500_YMmis.RData")
...
save(res5000_YMmis, func_list, forms, file = "results5/res5000_YMmis.RData")