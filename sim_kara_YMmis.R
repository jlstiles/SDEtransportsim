...
save(res100_YMmis, func_list, covariates, file = "results4/res100_YMmis.RData")
...
save(res500_YMmis, func_list, covariates, file = "results4/res500_YMmis.RData")
...
save(res5000_YMmis, func_list, covariates, file = "results4/res5000_YMmis.RData")
