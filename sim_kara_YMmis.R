...
for (h in 1:2)
{
  ...
  save(res500_YMmis, func_list, forms, file = paste0("results",nn ,"/res100_YMmis.RData"))
  ...
  save(res5000_YMmis, func_list, forms, file = paste0("results",nn ,"/res100_YMmis.RData"))
}