...
forms = list(Sform = "S~W1", Aform = NULL, Zstarform = "Z ~ A+W2+S", Mstarform = "M ~ Z", 
...
save(res100_YMmis, func_list, covariates, file = "results5/res100_YMmis.RData")
...
save(res500_YMmis, func_list, covariates, file = "results5/res500_YMmis.RData")
...
save(res5000_YMmis, func_list, covariates, file = "results5/res5000_YMmis.RData")