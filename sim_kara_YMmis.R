...
save(res100_YMmis, func_list, forms, file = "results9/res100_YMmis.RData")
...
save(res500_YMmis, func_list, forms, file = "results9/res500_YMmis.RData")
...
save(res5000_YMmis, func_list, forms, file = "results9/res5000_YMmis.RData")