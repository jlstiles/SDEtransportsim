...
for (h in 1:2)
{
  ...
  save(res500_YSmis, func_list, forms, file = paste0("results", nn, "/res100_YSmis.RData"))
  ...
  save(res5000_YSmis, func_list, forms, file = paste0("results", nn, "/res100_YSmis.RData"))
