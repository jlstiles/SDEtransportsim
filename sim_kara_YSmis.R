...
save(res100_YSmis, func_list, forms, file = "results9/res100_YSmis.RData")
...
save(res500_YSmis, func_list, forms, file = "results9/res500_YSmis.RData")
...
save(res5000_YSmis, func_list, forms, file = "results9/res5000_YSmis.RData")
