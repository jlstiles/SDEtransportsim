...
save(res100_YSmis, func_list, covariates, file = "results4/res100_YSmis.RData")
...
save(res500_YSmis, func_list, covariates, file = "results4/res500_YSmis.RData")
...
save(res5000_YSmis, func_list, covariates, file = "results4/res5000_YSmis.RData")
