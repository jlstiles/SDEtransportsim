...
#   i = i + 1
#   print(i)
#   x = sample(1:2000000, 1)
#   set.seed(x)
#   test = try(sim_kara(n, covariates, func_list))
#   if (class(test)=="try-error") break 
# }
# x
...
n=100
debug(SDE_tmle3)
res100_misA = mclapply(1:B, FUN = function(x) sim_kara(n, covariates, func_list), 
         mc.cores = getOption("mc.cores", 24L))


res100_misA

save(res100_misA, func_list, file = "res100_misA.RData")
